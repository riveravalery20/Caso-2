...
La distribución de los controles prenatales en la muestra se presenta en la Tabla \_\_\_. 
...
La distribución del número de embarazos  en la muestra se presenta en la Tabla \_\_\_. 
...
Los resultados publicados se consideran muy apropiados, teniendo como referencia el reporte, que nos indica que hay un 84,34% de proporción total de predicciones correctas, un 89,83% de capacidad de detección para casos de desnutrición real, un 79,12% de capacidad de identificar correctamente casos sin desnutrición, un 80,33% de precisión cuando predice desnutrición, un 89,13% de precisión cuando predice casos de no desnutrición, un 48,70% de proporción real de desnutrición en los datos y un 87,09% de una capacidad general de discriminación de todos los datos.
