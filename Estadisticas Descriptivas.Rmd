...
# GRÁFICO 1: DISTRIBUCIÓN DEL PESO DELICADO (PIE CHART)
...
plot_ly(
  ...
  plotly::layout(
    title = list(
      text = "<b>Gráfico 1. Distribución del Peso Delicado del Recién Nacido</b><br><sub>Bogotá - Segundo Semestre 2024</sub>",
      x = 0.5,
      font = list(size = 16)
    ),
    legend = list(
...
# GRÁFICO 5: DISTRIBUCIÓN DE CONTROLES PRENATALES
library(ggplot2)
...
ggplot(Base_datos, aes(x = Numero_control_prenatal)) +
  ...
  labs(title = "GRÁFICO 5:Distribución del Número de Controles Prenatales",
...
# GRÁFICO 6: DISTRIBUCIÓN DE NÚMERO DE EMBARAZOS
ggplot(Base_datos, aes(x = Numero_embarazos)) +
  ...
  geom_vline(aes(xintercept = mean(Numero_embarazos)), 
             color = "#27AE60", linetype = "dashed", linewidth = 1) +
  labs(title = "GRÁFICO 6: Distribución del Número de Embarazos",
       subtitle = "Bogotá - Segundo Semestre 2024",
